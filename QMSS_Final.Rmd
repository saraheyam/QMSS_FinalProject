...
training <- training[, c(3:4, 8, 12:15, 17:22)]
testing <- testing[, c(3:4, 8, 12:15, 17:22)]
```
...
train_fctr <- train_fctr[, c(3:5, 7:8, 12:15, 17:22)]
test_fctr <- test_fctr[, c(3:5, 7:8, 12:15, 17:22)]
```
...
train_fctr <- train_fctr[, c(3:5, 7:8, 12:15, 17:22)] %>% distinct(.)
test_fctr <- test_fctr[, c(3:5, 7:8, 12:15, 17:22)] %>% distinct(.)
```
